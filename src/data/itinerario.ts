...
export const ITINERARIO: BloqueDia[] = [
  {
    ...
    actividades: [
      ...
      { hora: '', titulo: 'Hotel → Parque Nacional Tula', detalle: '~15–20 min', esTraslado: true },
      { hora: '', titulo: 'Inauguración del encuentro', detalle: 'Parque Nacional Tula' },
      { hora: '', titulo: 'Sendero con huellas', detalle: 'Pendiente: definir proceso, sitio y materiales', pendiente: true },
      { hora: '', titulo: 'SIGs Henomotita', detalle: 'Pendiente: reunión presencial y capacitación virtual', pendiente: true },
      { hora: '', titulo: 'Parque Nacional Tula → Grutas Xoxafi', detalle: '~50–60 min', esTraslado: true },
      { hora: '', titulo: 'Comida', detalle: 'Gestión con presidente municipal — Grutas Xoxafi' },
      { hora: '', titulo: 'Reforestación', detalle: 'Grutas Xoxafi' },
      { hora: '', titulo: 'Recorrido', detalle: 'Grutas Xoxafi' },
      { hora: '', titulo: 'Mural', detalle: 'Propuesta: realizar antes del evento' },
      { hora: '', titulo: 'Feria ambiental', detalle: 'Grutas Xoxafi' },
      { hora: '', titulo: 'Capacitación de maguey', detalle: 'Grutas Xoxafi' },
      { hora: '', titulo: 'Grutas Xoxafi → Hotel Tula', detalle: '~50–60 min', esTraslado: true },
      { hora: '', titulo: 'Cena', detalle: 'Hotel Tula' },
